...
temperatures = np.linspace(0.1,1.5,20).tolist()
burn_in_steps = int((num_iterations/(number_of_MC_steps*N))*0.5)
time_average_proportion = 0.8
initial_up_ratio =0.5
results_path = save_results(simulation_type="fully_connected", initial_up_ratio=initial_up_ratio)
